            ...
            <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
                ...
                >
                    <AnimatedWords
                        title={"Contacto"}
                        style={
                            "flex max-w-[200px] flex-col items-start text-left text-[50px] font-extrabold uppercase leading-[0.9em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[80px] md:text-[90px] lg:text-center lg:text-[100px] xl:text-[200px]  "
                        }
                    />
                </div>
                ...
                <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
                    <div className=" flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
                        <AnimatedBody
                            text={
                                "Que esperas para contactarme? Estoy disponible para proyectos Freelance, Presupuestos, Colaboraciones y Consultas. ¡Hablemos!"
                            }
                            className={
                        ...
                        <Link
                            ...
                            target="_blank"
                            aria-label="Contactemos en LinkedIn"
